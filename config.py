...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/GOVIND-BOTS/zedzemusic")
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://te.legra.ph/file/01d39902154eebe1b02cd.jpg")
